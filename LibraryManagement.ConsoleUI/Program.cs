...
bookService.GetAllBookByCategoryId(2);
...
//    Book book = new Book(id, categoryId, authorId, title, description, pageSize, publishDate, isbn);
//    return book;
//}

bool AddBookValidator(Book book, List<Book> books)
{
    bool isUnique = true;
